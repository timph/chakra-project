...
class TickerService {
   ...
   * A callback that is called when the stock prices change for watched companies.
   */
  // potential issue: memory leak - keep growing without clear
  ...
  constructor() {
    ...
    // Every 300ms, update the price and market cap of all companies
    setInterval(() => {
  ...
  onDataChanged(callback: OnDataChangedCallback): void {
    ...
    // potential multi-threaded system hit at the same time > 1 fns added
